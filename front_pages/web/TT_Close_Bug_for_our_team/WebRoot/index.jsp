...
<body>
	<center>
		...
		<!-- Info Table -->
		<form action="main_tab.action" method="get">
			<table>
				<tr>
				...
				<tr>
					<td>User Name:</td>
					<td><input name="userInfo.username" type="text" value="junzheng_zhang"></td>
				</tr>
				<tr>
					<td>Password:</td>
					<td><input name="userInfo.password" type="password" value="123456"></td>
				</tr>
				<tr>
					<td>Project:</td>
